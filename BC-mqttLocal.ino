...
#define MQTT_HOST IPAddress(192,168,137,224)
...
void setup() {
  ...
  mpuTimer.attach(0.1, ReadPublish);
}
...
void ReadPublish(){
  ...
  uint16_t packetIdPub1 = mqttClient.publish("test/lol9", 1, true, data.c_str());
